...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Menue_Option_Page',
          path: '/menueOptionPage',
          builder: (context, params) => MenueOptionPageWidget(),
        ),
        FFRoute(
          name: 'About_Us_Page',
          path: '/aboutUsPage',
        ...
        FFRoute(
          name: 'Emergency_Page',
          path: '/emergencyPage',
          builder: (context, params) => EmergencyPageWidget(),
        ),
        FFRoute(
          name: 'Recent_Page',
          path: '/recentPage',
          builder: (context, params) => RecentPageWidget(),
        ),
        FFRoute(
          name: 'Search_Page',
          path: '/searchPage',
